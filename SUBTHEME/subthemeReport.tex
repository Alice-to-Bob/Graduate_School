...
\documentclass[11pt,a4paper,titlepage]{jreport}
...
本研究では、L2スイッチ一台とCentOS8.0のインストールされたサーバ三台を用いて一台をGateway Server、残りの二台をHost Server
とすることで、
...
実際のterminalの画面出力を以下図\ref{sshuttle_console}に示す。

\begin{figure}[h]
    \centering
    \includegraphics[width=1.0\textwidth, page=1]{graphs/sshuttle_console_first.png}
    \caption{sshuttleのVPN構築時のコンソール画面}
    \label{sshuttle_console}
\end{figure}

\begin{figure}[h]
    \centering
    \includegraphics[width=1.0\textwidth, page=1]{graphs/sshuttle_ssh.png}
    \caption{sshuttle後隔離ホストへのssh接続画面}
    \label{sshuttle_ssh}
\end{figure}
